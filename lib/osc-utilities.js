(function () {
  ...
  oscTypeCodes = {
    ...
    b: {
      ...
      split: function (buffer, strict) {
        var length, ref;
        (ref = exports.splitInteger(buffer)),
          (length = ref.integer),
          (buffer = ref.rest);
        return {
  ...
  exports.argToTypeCode = function (arg, strict) {
    ...
    if (
      ...
      (code = exports.typeStringToOscTypeCode(arg.type)) != null
    ) {
      return code;
    }
  ...
  exports.fromOscMessage = function (buffer, strict) {
    var address,
      ...
      typeString,
      types;
    (ref = exports.splitOscString(buffer, strict)),
      (address = ref.string),
      (buffer = ref.rest);
    if (strict && address[0] !== "/") {
    ...
    (ref1 = exports.splitOscString(buffer, strict)),
      (types = ref1.string),
      (buffer = ref1.rest);
    if (types[0] !== ",") {
      if (strict) {
  ...
  exports.fromOscBundle = function (buffer, strict) {
    ...
    (ref1 = exports.splitTimetag(buffer)),
      (timetag = ref1.timetag),
      (buffer = ref1.rest);
  ...
  exports.toOscBundle = function (bundle, strict) {
    ...
    timetag =
      (ref = bundle != null ? bundle.timetag : void 0) != null
        ? ref
        : new Date();
    elements =
  ...
  exports.applyMessageTranformerToBundle = function (transform) {
    return function (buffer) {
      var bundleTagBuffer,
        ...
        timetagBuffer,
        totalLength;
      (ref = exports.splitOscString(buffer)),
        (string = ref.string),
        (buffer = ref.rest);
      if (string !== "#bundle") {
        throw new Error("osc-bundles must begin with #bundle");
